...
public class ServidoresPesquisarFuncionarioDAO 
{
    
    Connection con;
    PreparedStatement pstm;
    ResultSet rs;
    ArrayList<ServidoresPesquisarFuncionarioDTO> lista = new ArrayList<>();
    String ComandoSqlParaPesquisa;
    String DigitadoNoCampoPesquisa;
    
    public ServidoresPesquisarFuncionarioDAO(String ComandoSqlParaPesquisa, String DigitadoNoCampoPesquisa)
    {
        this.setComandoSqlParaPesquisa(ComandoSqlParaPesquisa);
        this.setDigitadoNoCampoPesquisa(DigitadoNoCampoPesquisa);
    }
    
    public ArrayList<ServidoresPesquisarFuncionarioDTO> pesquisarFuncionario()
    {
        String sql;
        ...
        try 
        {
            ...
            while(rs.next())
            {
                  ServidoresPesquisarFuncionarioDTO objPesquisarFuncionarioDTO = new ServidoresPesquisarFuncionarioDTO(); 
                  ...
                  objPesquisarFuncionarioDTO.setRegimeJuridico(rs.getString("regimeJuridico"));
                  objPesquisarFuncionarioDTO.setBoolChkCargoEmComissao(rs.getBoolean("cargoEmComissao"));
                  objPesquisarFuncionarioDTO.setLeiAtribuicaoCargoEmprego(rs.getString("leiAtribuicaoCargoEmprego"));
                  objPesquisarFuncionarioDTO.setLeiReajusteCargoEmprego(rs.getString("leiReajusteCargoEmprego"));
                  objPesquisarFuncionarioDTO.setNumeroConcurso(rs.getString("numeroConcurso"));
                  objPesquisarFuncionarioDTO.setClassificacaoConcurso(rs.getString("classificacaoConcurso"));
