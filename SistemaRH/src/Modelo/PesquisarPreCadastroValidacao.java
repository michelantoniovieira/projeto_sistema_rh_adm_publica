...
public class PesquisarPreCadastroValidacao extends PesquisarPreCadastroDTO
{
    public PesquisarPreCadastroValidacao(String modoDePesquisa, String digitadoNoCampoPesquisa)
    {
