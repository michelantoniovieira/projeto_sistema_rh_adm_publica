...
public class ServidoresCadastrarFuncionarioDAO 
{
    Connection conn;
    ...
    public void CadastrarFuncionario(ServidoresCadastrarFuncionarioDTO objcadastrarCadastrarFuncionarioDTO)
    {
        ...
        try
        {
            ...
            pstm.setBoolean(27, objcadastrarCadastrarFuncionarioDTO.isBoolChkCargoEmComissao());
            pstm.setString(28, objcadastrarCadastrarFuncionarioDTO.getLeiAtribuicaoCargoEmprego());
            pstm.setString(29, objcadastrarCadastrarFuncionarioDTO.getLeiReajusteCargoEmprego());
            pstm.setString(30, objcadastrarCadastrarFuncionarioDTO.getNumeroConcurso());
            pstm.setString(31, objcadastrarCadastrarFuncionarioDTO.getClassificacaoConcurso());
