...
import DAO.PesquisarBancaDAO;
import DTO.PesquisarBancaDTO;
import Modelo.PesquisarBancaControle;
 ...
 * @author miche
 */
public class frmPesquisarBanca extends javax.swing.JDialog
{
     ...
     */
    public frmPesquisarBanca(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
        PesquisarBancaControle controle = new PesquisarBancaControle("tudo", "");
    ...
    private void initComponents()
    {
        ...
        tbPesquisarFuncionarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String []
            {
                "Código Banca", "Banca", "Telefone Banca", "Responsável Banca", "Telefone Responsável", "Email Banca"
            }
        ));
    ...
    public void botaoBuscar()
    {
        ...
        PesquisarBancaControle controle = new PesquisarBancaControle(modoPesquisa, txtPesquisar.getText());
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(frmPesquisarBanca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                frmPesquisarBanca dialog = new frmPesquisarBanca(new javax.swing.JFrame(), true);
    ...
    private void listarValores(PesquisarBancaControle controle)
    {
        try
        {
            PesquisarBancaDAO objPesquisarBancaDAO = new PesquisarBancaDAO(controle.getComandoSqlParaPesquisa(), controle.getDigitadoNoCampoPesquisa());
            ...
            ArrayList<PesquisarBancaDTO> lista = objPesquisarBancaDAO.pesquisarBanca();
