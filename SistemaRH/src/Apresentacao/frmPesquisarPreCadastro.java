...
import Modelo.ServidoresPesquisarFuncionarioControle;
 ...
 * @author miche
 */
public class frmPesquisarPreCadastro extends javax.swing.JDialog {

    private ArrayList<ServidoresPesquisarFuncionarioDTO> lista;
    private int index;
     ...
     */
    public frmPesquisarPreCadastro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ServidoresPesquisarFuncionarioControle controle = new ServidoresPesquisarFuncionarioControle("tudo", "");
    ...
    private void initComponents() {
        ...
        cmbModoDePesquisa.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Matrícula", "Nome", "RG", "CPF", "Data de Nascimento", "Cargo/Emprego" }));
        ...
        tbPesquisarFuncionarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Matrícula", "Pronome de Tratamento", "Nome", "Data de Admissão", "Data de Nascimento", "Cargo", "Referência", "Função Gratificada", "RG", "Expedição", "Naturalidade", "Estado Civil", "Instrução", "CPF", "CNH", "Titulo de Eleitor", "Endereço", "Numero", "Bairro", "Cidade", "Celula 1", "Celular 2", "Celular 3", "E-mail", "Regime Juridico", "Cargo em Comissao", "Lei Atribuicao Cargo/Emprego", "Lei Remuneração Cargo/Emprego", "Numero Concurso", "Classificacao Concurso"
            }
        ));
    ...
    //BOTÃO BUSCAR
        ...
        ServidoresPesquisarFuncionarioControle controle = new ServidoresPesquisarFuncionarioControle(modoPesquisa, txtPesquisar.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPesquisarPreCadastro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmPesquisarPreCadastro dialog = new frmPesquisarPreCadastro(new javax.swing.JFrame(), true);
...
private void listarValores(ServidoresPesquisarFuncionarioControle controle)
    {
        try 
        {
            ServidoresPesquisarFuncionarioDAO objFuncionarioDAO = new ServidoresPesquisarFuncionarioDAO(controle.getComandoSqlParaPesquisa(), controle.getDigitadoNoCampoPesquisa());
            ...
            ArrayList<ServidoresPesquisarFuncionarioDTO> lista = objFuncionarioDAO.pesquisarFuncionario();
            ...
            for(int num = 0; num < lista.size(); num++)
            {
             model.addRow(new Object[]
             {
                ...
                lista.get(num).getPronomeTratamento(),
                lista.get(num).getNome(),
                lista.get(num).getDataAdmissao(),
                lista.get(num).getDataNascimento(),
                lista.get(num).getCargo(),
                lista.get(num).getReferencia(),
                lista.get(num).getFuncaoGratificada(),
                lista.get(num).getRg(),
                lista.get(num).getExp(),
                lista.get(num).getNaturalidade(),
                lista.get(num).getEstadoCivil(),
                lista.get(num).getInstrucao(),
                lista.get(num).getCpf(),
                lista.get(num).getCnh(),
                lista.get(num).getTituloEleitor(),
                lista.get(num).getEndereco(),
                lista.get(num).getNumero(),
                lista.get(num).getBairro(),
                lista.get(num).getCidade(),
                lista.get(num).getCelUm(),
                lista.get(num).getCelDois(),
                lista.get(num).getCelTres(),
                lista.get(num).getEmail(),
                lista.get(num).getRegimeJuridico(),
                lista.get(num).isBoolChkCargoEmComissao(),
                lista.get(num).getLeiAtribuicaoCargoEmprego(),
                lista.get(num).getLeiReajusteCargoEmprego(),
                lista.get(num).getNumeroConcurso(),
                lista.get(num).getClassificacaoConcurso(),
    ...
    public ArrayList<ServidoresPesquisarFuncionarioDTO> getLista() {
        return lista;
    }

    public void setLista(ArrayList<ServidoresPesquisarFuncionarioDTO> lista) {
        this.lista = lista;
    }    
